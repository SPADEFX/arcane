...
import { useBuilderUIStore, breakpointWidths } from "../stores/ui-store";
...
export function Canvas({ siteId }: CanvasProps) {
  ...
  return (
    <div
      className="flex-1 overflow-y-auto bg-[#111113]"
      onClick={() => setSelectedBlockId(null)}
    >
      <div
        className={`${breakpoint === "desktop" ? "force-desktop" : ""} breakpoint-${breakpoint} canvas-isolate relative mx-auto min-h-full transition-all duration-300 ${
